...
assert.equal(pkg.version, '3.10.1');
...
assert.match(source, /Usage: \/analyze-dialog \[help\|status \[--json\]\] \| subagents \[<target>\] \| subagent <id\|index\|path>/);
assert.match(source, /function renderCommandHelp\(\): string/);
